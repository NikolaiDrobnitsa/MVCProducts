...
<body>
<div class="container">
    <form class="input_container " method='post' enctype="multipart/form-data" >
...
//            echo "<script>alert('del'); </script>";
        ...
        if(isset($_POST['upload'])){
            ...
            if(!empty($_FILES['img_upload']['tmp_name']) and $img_type === 'image'){
                ...
                $conn->query("INSERT INTO prod_img (title, price, description , images) VALUES ('$title','$price','$description','$img')");
            }
        }
